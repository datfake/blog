...
import static com.ncc.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = BlogserverApp.class)
public class PostResourceIT {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getShortdescription()).isEqualTo(DEFAULT_SHORTDESCRIPTION);
    ...
    public void updatePost() throws Exception {
        ...
        assertThat(testPost.getShortdescription()).isEqualTo(UPDATED_SHORTDESCRIPTION);
